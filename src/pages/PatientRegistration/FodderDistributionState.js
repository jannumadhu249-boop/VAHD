...
const FodderDistributionState = () => {
  ...
  const handleAddSubmit = async e => {
    ...
    const invalidRows = addRows.some(
      row => !row.fodderItem || !row.quantity || !row.price
    )
    if (invalidRows) {
    ...
    <React.Fragment>
      <div className="page-content">
        <div className="container-fluid">
          <Breadcrumbs
            title="VAHD ADMIN"
            breadcrumbItem="Fodder Distribution State"
          />
                ...
                <Card className="mb-4 border-primary">
                  <CardBody>
                    <h5 className="text-primary mb-3">
                      <i className="bx bx-plus-circle me-2"></i>Add Fodder
                      Distribution
                    </h5>
                        ...
                        <tbody>
                          {addRows.map((row, idx) => (
                            <tr key={idx}>
                              ...
                              <td>
                                <Select
                                  value={fodderItemOptions.find(
                                    opt => opt.value === row.fodderItem
                                  )}
                                  onChange={opt =>
                                    handleAddRowChange(
                                      idx,
                                  ...
                                  isClearable
                                  isDisabled={
                                    loading.submit || loading.fodderItems
                                  }
                                />
                              </td>
                              <td>
                ...
                <Card className="mb-4 border-warning">
                  <CardBody>
                    <h5 className="text-warning mb-3">
                      <i className="bx bx-edit me-2"></i>Edit Fodder
                      Distribution
                    </h5>
                        ...
                        <Col md={4}>
                          <FormGroup>
                            ...
                            <Select
                              name="fodderItem"
                              value={fodderItemOptions.find(
                                opt => opt.value === editItem.fodderItem
                              )}
                              onChange={opt =>
                                setEditItem(prev => ({
                                  ...prev,
                                  fodderItem: opt?.value || "",
                                }))
                              }
                              options={fodderItemOptions}
                              styles={selectStyles}
                      ...
                      <div className="d-flex justify-content-between border-top pt-3">
                        ...
                        >
                          {loading.submit ? (
                            ...
                            <>
                              <i className="bx bx-check me-1"></i>Update
                            </>
                          )}
                        </Button>
                      </div>
...
export default FodderDistributionState