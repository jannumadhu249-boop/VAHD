...
//   const GetAnimalTypeByVaccinationType = useCallback(
//     async animalTypeId => {
//       if (!animalTypeId) {
//         setBreed([])
//         return
...
//           URLS.GetAnimalTypeByVaccinationType + animalTypeId,
//           {
//             headers: { Authorization: `Bearer ${token}` },
//           }
//         )
...
//       GetAnimalTypeByVaccinationType(selectedOption.value)
//       setForm(prev => ({ ...prev, vaccineType: "" }))
//     }
...
//         const response = await axios.get(
//           URLS.GetAnimalTypeByVaccinationType + data.animalTypeId,
//           {
//             headers: { Authorization: `Bearer ${token}` },
//           }
//         )
...
//         freshBreedOptions.find(opt => opt.value === data.vaccineType) || null
...
//         vaccineType: selectedBreedOption,
...
//     return form1.vaccineType && typeof form1.vaccineType === "object"
//       ? form1.vaccineType
//       : breedOptions.find(opt => opt.value === form1.vaccineType) || null
//   }
...
//       vaccineType: getSafeValue(form1.vaccineType),
...
//     return breedOptions.find(opt => opt.value === form.vaccineType) || null
//   }
...
//           <Breadcrumbs title="VAHD ADMIN" breadcrumbItem="Vaccination" />
...
//                                     {Roles?.VeterinaryInspectionEdit === true ||
//                                     Roles?.accessAll === true ? (
//                                       <>
//                                         <Button
...
//                                     {Roles?.VeterinaryInspectionDelete ===
