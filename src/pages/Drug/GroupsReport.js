...
//                   "Name Of the Firm": item.firmName || item.nameOfFirm || "-",
//                   "Name Of the Stockiest": item.stockiestName || item.nameOfStockiest || "-",
//                   Qty: item.qty || 0,
...
//       doc.text(
//         "DETAILED DISTRICT MEDICINES INDENT REPORT",
//         pageWidth / 2,
//         15,
//         { align: "center" }
//       )
...
//             item.unitPack || "-",
//             item.firmName || item.nameOfFirm || "-",
//             item.stockiestName || item.nameOfStockiest || "-",
//             {
...
//             },
//             {
//               content: `${item.salesTax || item.gst || 12}%`,
//               styles: { halign: "center" },
//             },
//             {
...
//               { content: "Firm Name", styles: { halign: "center" } },
//               { content: "Stockiest Name", styles: { halign: "center" } },
...
//       const fileName = `Detailed_Drug_Report_${financialYearText}_${
...
//                   disabled={isSearching || !selectedFinancialYearId}
//                 >
//                   {isSearching ? (
//                     <>
...
//                         <div className="text-center">
//                           <h5 className="mb-1">
//                             {group.group} {group.formTypeName}
//                           </h5>
//                         </div>
//                       </div>
...
//                                 </td>
//                                 <td>{item.unitPack || "-"}</td>
//                                 <td>{item.firmName || item.nameOfFirm || "-"}</td>
//                                 <td>{item.stockiestName || item.nameOfStockiest || "-"}</td>
...
//                             <td colSpan="16" className="text-end fw-bold">
//                               TOTAL
//                             </td>
...
//                   >
//                     <div className="d-flex justify-content-between mb-1">
//                       <span className="fw-bold">Total Budget Booked:</span>
//                       <span className="fw-bold">
...
//                   >
//                     <div className="d-flex justify-content-between mb-1">
//                       <span className="fw-bold">Total Balance Budget:</span>
//                       <span className="fw-bold">
//                         {grand_total.total_budget_balance}
//                       </span>
//                     </div>
...
//     return `STATEMENT SHOWING THE  ${districtName.toUpperCase()} DISTRICT MEDICINES INDENT`
//   }
...
//                       drugIndents.reduce(
//                         (sum, group) =>
//                           sum + (group.formBudget?.availableBudget || 0),
//                         0
//                       )
//                     )} */}
//                      {grand_total.total_budget_balance}
...
//                                 <td>{item.townName || "-"}</td>
//                                 <td>{item.workingPlaceName || "-"}</td>
//                                 <td>{item.drugCode?.slice(0, 20) || "-"}</td>
//                                 <td>{item.tradeName || "-"}</td>
//                                 <td>{item.compositionAndStrength || "-"}</td>
//                                 <td>
//                                   {item.packingSpecification?.slice(0, 20) ||
...
//                           drugIndents.reduce(
//                             (sum, group) =>
//                               sum + (group.formBudget?.bookedBudget || 0),
//                             0
//                           ),
//                           2
//                         )}
...
const GroupsReport = () => {
  ...
  const fetchDrugIndents = useCallback(
          ...
          groups.forEach(group => {
            if (group.data && Array.isArray(group.data)) {
              ...
              group.data.forEach(item => {
                ...
                totalAmount += parseFloat(item.total || item.amount || item.totalAmount || 0)
              })
            }
          })
            ...
            if (group.data && Array.isArray(group.data)) {
              group.data.forEach((item, index) => {
                csvDataArray.push({
                  ...
                  GST: item.salesTax ? `${item.salesTax}` : "-",
                  Total: formatNumber(item.total, 2),
                })
              })
            }
    ...
    [token, filters, selectedFinancialYearId, grand_total]
  )
                            ...
                            <tbody>
                              {group.data && Array.isArray(group.data) && group.data.map((item, index) => (
                                <tr key={item._id || index} className="text-center">
                                  ...
                                  <td>{item.unitPack || "-"}</td>
                                  <td className="text-center">{item.qty || 0}</td>
                                  <td className="text-end">{formatNumber(item.unitPrice, 2)}</td>
                                  <td className="text-end">{item.salesTax  || "-"}</td>
                                  <td className="text-center">
                                    {formatNumber(item?.total, 2) || "-"}
                                  </td>
                                </tr>
                ...
                {filteredDrugIndents.length > 0 && (
                  <div className="p-2 rounded mt-4">
                    <div className="row">
                      ...
                      >
                        <div className="d-flex justify-content-between mb-1">
                          <span className="fw-bold  fs-4"> Total Budget Released:</span>
                      ...
                      >
                        <div className="d-flex justify-content-between mb-1">
                          <span className="fw-bold  fs-4">Total Budget Booked:</span>
                          <span className="fw-bold fs-4">
                          <strong>
                      ...
                      >
                        <div className="d-flex justify-content-between mb-1">
                          <span className="fw-bold fs-4">Total Balance Budget:</span>
                          <span className="fw-bold fs-4">
                          <strong>
