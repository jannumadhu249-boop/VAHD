...
const Farmers = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const response = await axios.post(URLS.UploadFarmersExcel, formData, {
                headers: {
            ...
            if (response.data.success) {
                toast.success(
                    response.data.message || `File uploaded successfully for ${selectedDistrict.label} district`
                )
        ...
        <React.Fragment>
            <div className="page-content">
                <div style={{ height: "500px" }}>
                    ...
                    <Container fluid>
                        <Breadcrumbs title="Farmers" breadcrumbItem="Upload Farmers Data" />

                        <Row>
                            <Col lg={12}>
                                <Card>
                                    <CardBody>
                                        <h4 className="card-title mb-4">Upload Farmers Data</h4>
