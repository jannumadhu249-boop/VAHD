...
//     if (
//       (name === "employeeId" && value.length === 7) ||
//       (name === "phone" && value.length === 10)
//     ) {
//       getEmployeeRegistration(value)
//     }
//   }

//   const getEmployeeRegistration = data => {
//     if (!data || data.trim() === "") {
//       return
//     }
...
//     axios
//       .post(
//         URLS.GetEmployeeRegistationSearch + `${data}`,
//         {},
//         {
//           headers: { Authorization: `Bearer ${token}` },
//         }
...
//           if (firstStaff && firstStaff._id) {
//             sessionStorage.setItem("EmployeeRegistationid", firstStaff._id)
//             history.push("/edit-employee-registation")
//           } else {
//             console.warn("Staff data found but missing _id property")
//           }
//         } else {
//           console.log(
//             `Found ${staffData.length} staff records. Expected exactly 1.`
//           )
//         }
//       })
//       .catch(error => {
...
//       setErrors({})
//       setFileError("")
//       setPostingTypeIds(new Set())
//       setPlaceOfWorkingIds(new Set())
...
//         <Breadcrumbs
//           title="VAHD ADMIN"
//           breadcrumbItem="Add Employee Registration"
//         />
...
const AddEmployeeRegistration = () => {
  ...
  const handleDistrictChange = async (
    ...
    // Fetch places of working for selected district
    if (value) {
  ...
  const getPlaceOfWorkingOptions = (postingIndex, placeIndex) => {
    ...
    return placeOfWorking.map(place => ({
      value: place._id,
      label: place.name,
    }))
  }
...
//           // Initialize posting type IDs for duplicate validation
...
//           // Initialize place of working IDs for duplicate validation
...
// export default EditEmployeeRegistation
