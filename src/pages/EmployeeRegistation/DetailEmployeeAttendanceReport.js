...
function DetailEmployeeAttendanceReport() {
    ...
    const reportDateColumns = useMemo(() => {
        ...
        <React.Fragment>
            <div className="page-content">
                <div className="container-fluid">
                    <Breadcrumbs
                        title="VAHD ADMIN"
                        breadcrumbItem="Detail Employee Attendance Report"
                    />
                            ...
                            <Card style={styles.card}>
                                <CardBody>
                                    ...
                                    <Row className="mb-4">
                                        <Col md={6}>
                                            <h5 className="mb-0">
                                                {viewMode === "report" ? "Detail Employee Attendance Report" : "Attendance Abstract"}
                                        ...
                                        {viewMode === "report" ? (
                                            <Table hover className="mb-0">
                                                ...
                                                <tbody>
                                                    {loading ? (
                                                        <tr>
                                                            <td colSpan={5 + reportDateColumns.length} className="text-center py-5">
...
export default DetailEmployeeAttendanceReport