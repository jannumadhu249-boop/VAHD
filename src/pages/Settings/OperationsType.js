...
const OperationsType = () => {
  ...
  const SearchData = e => {
    ...
    axios
      .get(URLS.GetOperationsTypeSearch + `${e.target.value}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(
        res => {
  ...
  const AddData = () => {
    ...
    axios
      .post(URLS.AddOperationsType, dataArray, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(
        res => {
  ...
  const UpdateData = () => {
    ...
    axios
      .put(URLS.EditOperationsType + form1._id, dataArray, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(
        res => {
  ...
  const Delete = data => {
    ...
    var remid = data._id
    axios
      .delete(URLS.DeleteOperationsType + remid, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(
        res => {
    ...
    <React.Fragment>
      <div className="page-content">
        <div className="container-fluid">
          <Breadcrumbs title="VAHD ADMIN" breadcrumbItem="Surgical Type" />
          <Row>
            <Col md={12}>
              {show1 == true ? (
                <Card className="p-4">
                  ...
                  >
                    <h5 className="mb-3">Edit Surgical Type</h5>
                    <Row>
                      <Col md="6">
                        <Label>Name</Label>
              ...
              <>
                <Col md={4}>
                  <Card className="p-4">
                    ...
                    >
                      <h5 className="mb-3">Add Surgical Type </h5>
                      <Row>
                        <Col md="12">
                          <Label>Name</Label>
                          <span className="text-danger">*</span>
            ...
            <Col md={Roles?.SurgicalTypesAdd || Roles?.accessAll ? 8 : 12}>
              <Card>
                <CardBody>
                  <Row>
                    <Col>
                      <h5 className="mb-3"> Surgical Type List</h5>
                    </Col>
                    <Col>
