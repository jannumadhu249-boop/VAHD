...
const AddDesignation = () => {
  ...
  const [ras, setras] = useState({
    Dashboardview: false,
    EmployeeRegistationsView: false,
    EmployeeRegistationView: false,
    EmployeeRegistationAdd: false,
    EmployeeRegistationEdit: false,
    EmployeeRegistationDelete: false,
    MprSurgicalsView: false,
    MprSurgicalView: false,
    MprSurgicalAdd: false,
    MprSurgicalEdit: false,
    MprSurgicalDelete: false,
    PatientRegistrationView: false,
    CaseTreatedView: false,
    CaseTreatedAdd: false,
    CaseTreatedEdit: false,
    CaseTreatedDelete: false,
    DewormingView: false,
    DewormingAdd: false,
    DewormingEdit: false,
    DewormingDelete: false,
    CastrationView: false,
    CastrationAdd: false,
    CastrationEdit: false,
    CastrationDelete: false,
    VaccinationView: false,
    VaccinationAdd: false,
    VaccinationEdit: false,
    VaccinationDelete: false,
    SurgicalView: false,
    SurgicalAdd: false,
    SurgicalEdit: false,
    SurgicalDelete: false,
    GoatDewormingsView: false,
    GoatDewormingView: false,
    GoatDewormingAdd: false,
    GoatDewormingEdit: false,
    GoatDewormingDelete: false,
    FoddersView: false,
    FodderView: false,
    FodderAdd: false,
    FodderEdit: false,
    ...
    AIEdit: false,
    AIDelete: false,
    VeterinaryInspectionsView: false,
    VeterinaryInspectionView: false,
    VeterinaryInspectionAdd: false,
    VeterinaryInspectionEdit: false,
    VeterinaryInspectionDelete: false,
    DrugIndentsView: false,
    DrugIndentView: false,
    DrugIndentAdd: false,
    DrugIndentEdit: false,
    DrugIndentDelete: false,
    SettingsView: false,
    DistrictView: false,
    DistrictAdd: false,
    DistrictEdit: false,
    DistrictDelete: false,
    MandalView: false,
    MandalAdd: false,
    MandalEdit: false,
    MandalDelete: false,
    ...
    TownEdit: false,
    TownDelete: false,
    TypeOfInstitutionView: false,
    TypeOfInstitutionAdd: false,
    TypeOfInstitutionEdit: false,
    TypeOfInstitutionDelete: false,
    PlaceOfWorkingView: false,
    PlaceOfWorkingAdd: false,
    PlaceOfWorkingEdit: false,
    PlaceOfWorkingDelete: false,
    DesignationView: false,
    DesignationAdd: false,
    DesignationEdit: false,
    DesignationDelete: false,
    EmployeeTypeView: false,
    EmployeeTypeAdd: false,
    EmployeeTypeEdit: false,
    EmployeeTypeDelete: false,
    TypeOfPostingView: false,
    TypeOfPostingAdd: false,
    TypeOfPostingEdit: false,
    TypeOfPostingDelete: false,
    DiagnosticView: false,
    DiagnosticAdd: false,
    DiagnosticEdit: false,
    DiagnosticDelete: false,
    AnimalTypesView: false,
    AnimalTypesAdd: false,
    AnimalTypesEdit: false,
    AnimalTypesDelete: false,
    BreedsView: false,
    BreedsAdd: false,
    BreedsEdit: false,
    BreedsDelete: false,
    VaccinationTypeView: false,
    VaccinationTypeAdd: false,
    VaccinationTypeEdit: false,
    VaccinationTypeDelete: false,
    ItemsView: false,
    ItemsAdd: false,
    ItemsEdit: false,
    ItemsDelete: false,
    SurgicalTypesView: false,
    SurgicalTypesAdd: false,
    SurgicalTypesEdit: false,
    SurgicalTypesDelete: false,
    SurgicalsView: false,
    SurgicalsAdd: false,
    SurgicalsEdit: false,
    SurgicalsDelete: false,
    QualificationsView: false,
    QualificationsAdd: false,
    QualificationsEdit: false,
    QualificationsDelete: false,
    SpecializationView: false,
    SpecializationAdd: false,
    SpecializationEdit: false,
    SpecializationDelete: false,
    GrampanchayathView: false,
    GrampanchayathAdd: false,
    GrampanchayathEdit: false,
    GrampanchayathDelete: false,
    AttendanceReportView: false,
    CompleteAttendanceReportView: false,
    DetailAttendanceReportView: false,
    LeavesManagement: false,
    AllocationFormView: false,
    AllocationFormAdd: false,
    AllocationFormEdit: false,
    AllocationFormDelete: false,
    DrugView: false,
    DrugAdd: false,
    DrugEdit: false,
    DrugDelete: false,
    FinancialYearView: false,
    FinancialYearAdd: false,
    FinancialYearEdit: false,
    FinancialYearDelete: false,
    SchemeView: false,
    SchemeAdd: false,
    SchemeEdit: false,
    SchemeDelete: false,
    ...
    QuarterEdit: false,
    QuarterDelete: false,
    PercentageAllocationView: false,
    PercentageAllocationAdd: false,
    PercentageAllocationEdit: false,
    PercentageAllocationDelete: false,
    PoliciesView: false,
    PoliciesAdd: false,
    PoliciesEdit: false,
    PoliciesDelete: false,
    ReportsView: false,
    InstitutionReportView: false,
    DistrictWiseDVAHOReportView: false,
    GroupWiseDistrictReportView: false,
    DistrictWiseAbstractReportView: false,
    DistrictWiseInstCountReportView: false,
    InstitutionDrugReportView: false,
    InstitutionProgressReportView: false,
    DrugReportView: false,
    InstitutionProgressAbstractView: false,
    InventoryManagementView: false,
    DetailedDrugReportView: false,
    DocumentManagementView: false,
    CaseTreatedReportView: false,
    ArtificialInseminationReportView: false,
    FodderReportView: false,
    FarmersReportView: false,
    FarmersAbstractReportView: false,
  })
