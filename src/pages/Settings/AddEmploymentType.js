...
const Roles = () => {
  ...
  const [ras, setras] = useState({
    ...
    MprOperationView: false,
    MprOperationAdd: false,
    MprOperationEdit: false,
    MprOperationDelete: false,
    PatientRegistrationView: false,
    PatientRegistrationAdd: false,
    PatientRegistrationEdit: false,
    PatientRegistrationDelete: false,
  ...
  const Addrole = () => {
    ...
    axios
      .post(URLS.AddEmploymentType, data, {
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            title="VAHD ADMIN"
            breadcrumbItem="Add Type of Insitution"
          />
          <Row>
            <Col>
              <Button
            ...
            <Col md={12}>
              <Card>
                <CardHeader className="bg-white mt-2">
                  <CardTitle>Add Type of Insitution</CardTitle>
                </CardHeader>
                <CardBody>
                  <Form
                    onSubmit={e => {
