...
const Items = () => {
  ...
  const SearchData = e => {
    ...
    axios
      .post(
        URLS.GetAllItemsSearch + `${e.target.value}`,
        {},
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const UpdateData = () => {
    ...
    axios
      .put(URLS.EditItems + form1._id, dataArray, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(
        res => {
    ...
    <React.Fragment>
      <div className="page-content">
        <div className="container-fluid">
          <Breadcrumbs title="VAHD ADMIN" breadcrumbItem="Items" />
          <Row>
            <Col md={12}>
              {show1 == true ? (
                <Card className="p-4">
                  ...
                  >
                    <h5 className="mb-3">Edit Items</h5>
                    <Row>
                      <Col md="6">
                        <Label>Name</Label>
          ...
          <Row>
            {Roles?.ItemsAdd === true || Roles?.accessAll === true ? (
              <>
                <Col md={4}>
                  <Card className="p-4">
                    <Form
            ...
            <Col md={Roles?.ItemsAdd || Roles?.accessAll ? 8 : 12}>
              <Card>
                <CardBody>
                  <Row>
                    <Col>
                      <h5 className="mb-3"> Items List</h5>
                    </Col>
                    <Col>
